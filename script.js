...
function changeColour(){
  ...
  document.getElementsByClassName("key black")[5].style.background=array[0];
  document.getElementsByClassName("key black")[6].style.background=array[0];
  document.getElementsByClassName("key black")[7].style.background=array[0];
  document.getElementsByClassName("key black")[8].style.background=array[0];
  ...
  document.getElementsByClassName("key white")[7].style.background=array[1];
  document.getElementsByClassName("key white")[8].style.background=array[1];
  document.getElementsByClassName("key white")[9].style.background=array[1];
  document.getElementsByClassName("key white")[10].style.background=array[1];
  document.getElementsByClassName("key white")[11].style.background=array[1];
  document.getElementsByClassName("key white")[12].style.background=array[1];
 }